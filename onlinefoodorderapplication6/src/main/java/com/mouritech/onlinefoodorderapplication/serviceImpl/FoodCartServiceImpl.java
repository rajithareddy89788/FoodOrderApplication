...
import com.mouritech.onlinefoodorderapplication.controller.ApiResponse;
import com.mouritech.onlinefoodorderapplication.controller.Product;
...
//	
	...
	public void addToCart1(AddToCartDto addToCartDto, List<Items> items, Customer user){
        FoodCart cart = new FoodCart(items, addToCartDto.getQuantity(), user);
        cartRepository.save(cart);
    }
	public FoodCart createCart2(AddToCartDto addToCartDto, List<Items> items, String customerName) {
		...
		//Restaurant restaurant = restaurantRepository.findByRestaurantName(restaurantName);
		Items product = productService.getProductById(addToCartDto.getProductId());
