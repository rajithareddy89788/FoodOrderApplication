...
//	
		...
		public void addToCart1(AddToCartDto addToCartDto, Items items){
	        FoodCart cart = new FoodCart(items, addToCartDto.getNo_of_items());
	        cartRepository.save(cart);
	    }
		public CartDto listCartItems( ) {
	        List<FoodCart> cartList = cartRepository.findAll();
	        List<CartItemDto> cartItems = new ArrayList<>();
	        for (FoodCart foodcart:cartList){
	            CartItemDto cartItemDto = getDtoFromCart(foodcart);
