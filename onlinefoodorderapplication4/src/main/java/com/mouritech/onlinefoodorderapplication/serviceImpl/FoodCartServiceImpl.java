...
import com.mouritech.onlinefoodorderapplication.dto.RestaurantItemCartDto;
...
//	
		...
		public FoodCart createCart(RestaurantItemCartDto cartDto, String customerName) {
			
			List<Items> myList = new ArrayList<>();

			Customer existingcustomer = customerRepository.findByCustomerName(customerName);
			List<Restaurant>restaurant = restaurantRepository.findByRestaurantName(restaurantName);
			List<Items> restItems = restaurant.getItems();
			for (Items result : restItems) {
