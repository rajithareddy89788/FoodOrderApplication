...
//	}
	...
	public ResponseEntity<?> findCustomerByEmailAndPassword(
			@RequestBody CustomerVerificationDto customerVerificationDto) {

		Customer result = customerService.findCustomerByEmailAndPassword(customerVerificationDto.getCustomerEmail(),
				customerVerificationDto.getCustomerPassword());
		if (result != null) {
